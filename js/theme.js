  ...
  var THEMES = {
    fosforo: {
      ...
      vars: {
        ...
        '--canvas-hue':'0deg',
        '--c-a22':'rgba(0,255,102,0.13)',
        '--c-a33':'rgba(0,255,102,0.20)',
        '--c-a44':'rgba(0,255,102,0.27)',
        '--c-a55':'rgba(0,255,102,0.33)',
        '--c-a88':'rgba(0,255,102,0.53)',
        '--c-bg-tint':'#000305',
      }
    },
    ambar: {
      ...
      vars: {
        ...
        '--canvas-hue':'-102deg',
        '--c-a22':'rgba(255,176,0,0.13)',
        '--c-a33':'rgba(255,176,0,0.20)',
        '--c-a44':'rgba(255,176,0,0.27)',
        '--c-a55':'rgba(255,176,0,0.33)',
        '--c-a88':'rgba(255,176,0,0.53)',
        '--c-bg-tint':'#050300',
      }
    },
    hielo: {
      ...
      vars: {
        ...
        '--canvas-hue':'69deg',
        '--c-a22':'rgba(51,153,255,0.13)',
        '--c-a33':'rgba(51,153,255,0.20)',
        '--c-a44':'rgba(51,153,255,0.27)',
        '--c-a55':'rgba(51,153,255,0.33)',
        '--c-a88':'rgba(51,153,255,0.53)',
        '--c-bg-tint':'#00030a',
      }
    },
    rojo: {
      ...
      vars: {
        ...
        '--canvas-hue':'216deg',
        '--c-a22':'rgba(255,51,51,0.13)',
        '--c-a33':'rgba(255,51,51,0.20)',
        '--c-a44':'rgba(255,51,51,0.27)',
        '--c-a55':'rgba(255,51,51,0.33)',
        '--c-a88':'rgba(255,51,51,0.53)',
        '--c-bg-tint':'#060000',
      }
    }
  };
